...
const Contact = () => {
  ...
  return (
    <div name="contact" className="bg-gradient-to-b from-black to-gray-800 p-4 text-white w-full min-h-screen flex items-center">
      <div className="flex flex-col p-8 justify-center max-w-screen-lg mx-auto w-full h-full">
        <div className="pb-6 pt-12 flex justify-center items-center">
